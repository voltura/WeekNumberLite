...
SET "REPO_NAME=WeekNumberLite"
:: v%VERSION%
SET "TAG_NAME=" 
:: BRANCH (master)
SET "TARGET_COMMITISH=master"
:: WeekNumber Lite %VERSION%
SET "NAME="
...
:: Script logic
:: ==========================
TITLE Creating WeekNumber Lite release...
COLOR 1F
CLS
CALL :UPDATE_VERSION
...
PUSHD "%SCRIPT_DIR%\.."
	CALL "%MSBUILD_FULLPATH%" WeekNumberLite.sln /p:Platform=x86 /t:Clean,Build /property:Configuration=Release -maxcpucount >NUL
...
SET "NAME=WeekNumber Lite %VERSION%"
