...
<img src="https://user-images.githubusercontent.com/2292809/120221521-d6a79580-c23e-11eb-99d1-be6210b43fcf.png" data-canonical-src="https://user-images.githubusercontent.com/2292809/120221521-d6a79580-c23e-11eb-99d1-be6210b43fcf.png" alt="WeekNumberLite" width="150" height="150" /> ![image](https://user-images.githubusercontent.com/2292809/120940539-0f071200-c71e-11eb-8b03-8f24b9fb36ad.png)


[![Latest release ZIP](https://img.shields.io/github/v/release/voltura/WeekNumberLite?label=download%20latest%20release&style=for-the-badge)](https://github.com/voltura/WeekNumberLite/releases/latest/download/WeekNumberLite.zip)
...
![WeekNumberLite form](https://user-images.githubusercontent.com/2292809/120942749-3a442e00-c72b-11eb-8b16-88fcbfe756f1.png)
...
If you downloaded WeekNumberLite.zip via [*Download latest release*](https://github.com/voltura/WeekNumberLite/releases/latest/download/WeekNumberLite.zip) first unzip the archive, then run the installer.
...
> WeekNumberLite_{VERSION}_Installer.exe /S

To silently uninstall call the uninstaller with /S parameter.
> Uninstall WeekNumberLite.exe /S
...
- **About WeekNumberLite** - _Displays version information_
...
- **Settings**
   ...
   - **Icon** - _Application icon settings_
     ...
     - **Icon resolution** - _Possibility to tweak the WeekNumberLite icon resolution, if the icon is fuzzy setting a higher or lower resolution can help with apperance_
     - **Graphics settings** - _Possibility to tweak icon graphics settings used by the application when drawing the week number icon_
       ...
       - **Interpolation Mode**
       - **Text Contrast**
     - **Save icon...** - _Saves the current WeekNumberLite icon displayed to a .ico file_
...
- **Exit WeekNumberLite** - _Closes the application. Start it again from the Windows Start Menu_

## Donations
*- WeekNumberLite is completely free and open source. Donations are very much appreciated!*
