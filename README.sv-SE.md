...
[![Latest release ZIP](https://img.shields.io/github/v/release/voltura/WeekNumberLite?label=ladda%20ner%20senaste%20versionen&style=for-the-badge)](https://github.com/voltura/WeekNumberLite/releases/latest/download/WeekNumberLite.zip)
...
![WeekNumberLite formulär](https://user-images.githubusercontent.com/2292809/121432297-c730f680-c97a-11eb-9530-005d5062039b.png)
...
Om du laddat ned WeekNumberLite.zip via *LADDA NER SENASTE VERSIONEN* packa först upp arkivet och kör sedan installationsprogrammet.
...
Välj om WeekNumberLite ska startas med Windows och om applikationen ska startas då installationen är klar, tryck sedan _Slutför_

![image](https://user-images.githubusercontent.com/2292809/121436875-a15b2000-c981-11eb-9ebb-db089999b830.png)
   
En notis visas då WeekNumberLite är startad
...
### Högerklicks-meny:
- **Om WeekNumberLite** - _Visar versionsinformation_
...
- **Inställningar**
   ...
   - **Ikon** - _Inställningar för applikationsikon_
     ...
     - **Ikonupplösning** - _Möjlighet att anpassa WeekNumberLite-ikonens upplösning, om ikonen ser suddig ut kan en annan upplösning ge bättre ikonutseende_
     - **Grafikinställningar** - _Möjlighet att anpassa grafikalternativ som nyttjas då ikonen ritas av applikationen_
       - **Utjämningsläge**
       - **Kompositkvalitet**
       - **Interpolationsläge**
       - **Textkontrast**
     - **Spara ikon...** - _Sparar aktuell WeekNumberLite-ikon till en .ico fil_
...
- **Avsluta WeekNumberLite** - _Avslutar applikationen. Starta igen från Windows Startmeny_

## Donationer
*- WeekNumberLite är fullständigt gratis och öppen källkod. Donationer uppskattas!*
