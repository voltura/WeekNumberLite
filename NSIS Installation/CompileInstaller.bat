@ECHO OFF
TITLE Compiling WeekNumber Lite installer...
...
SET INSTALLER="%INSTALL_SCRIPT_FOLDER%\WeekNumber_Lite_%VERSION%_Installer.exe"
SET INSTALL_LOG="%INSTALL_SCRIPT_FOLDER%\WeekNumber_Lite_%VERSION%_Installer.log"
SET INSTALL_SCRIPT="%INSTALL_SCRIPT_FOLDER%\WeekNumberLite.nsi"
